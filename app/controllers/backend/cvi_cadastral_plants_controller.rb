module Backend
  class CviCadastralPlantsController < Backend::CviBaseController
    ...
    def update
      ...
      cadastral_land_parcel = RegisteredCadastralParcel.find_with(RegisteredPostalCode.find(permitted_params[:location_attributes][:registered_postal_zone_id])&.code,
