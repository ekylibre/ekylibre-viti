module Backend
  class IncomingHarvestsController < Backend::BaseController
    ...
    list(conditions: incoming_harvests_conditions) do |t|
      t.action :edit
      t.action :destroy
    ...
    list(:plants, model: :incoming_harvest_plant, joins: :plant, conditions: { incoming_harvest_id: 'params[:id]'.c }) do |t|
    ...
    list(:storages, model: :incoming_harvest_storage, conditions: { incoming_harvest_id: 'params[:id]'.c }) do |t|
