    ...
    displayCadastralLandParcelZone: (visible = true) =>
      ...
      if @getZoom() >= 16
        ...
        onSuccess = (data) =>
          ...
          cadastralZonesSerie = [{cadastral_land_parcel_zones: data}, [name: 'cadastral_land_parcel_zones', label: 'Parcelles cadastrales', type: 'simple', index: true, serie: 'cadastral_land_parcel_zones', onEachFeature: onEachFeature, style: style]]
