...
class FormattedCviLandParcelTest < Ekylibre::Testing::ApplicationTestCase::WithFixtures
  ...
  should 'have the correct column names' do
    column_names = %w[id name commune locality designation_of_origin_name vine_variety_name declared_area_value calculated_area_value declared_area_formatted calculated_area_formatted inter_vine_plant_distance_value inter_row_distance_value state rootstock]
